...
func TestRoutingTable(t *testing.T) {
	...
	rt.AddContact(NewContact(NewNodeID("1111111400000000000000000000000000000000"), "localhost:8002"))
	rt.AddContact(NewContact(NewNodeID("2111111400000000000000000000000000000000"), "localhost:8002"))
